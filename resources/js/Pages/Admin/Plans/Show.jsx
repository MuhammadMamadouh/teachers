            ...
            <div className="py-12">
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <h3 className="text-lg font-medium text-gray-900 mb-4">Plan Overview</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                <div className="bg-blue-50 p-4 rounded-lg">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-3">
                                            <p className="text-sm font-medium text-blue-900">Student Limit</p>
                                ...
                                <div className="bg-green-50 p-4 rounded-lg">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-3">
                                            <p className="text-sm font-medium text-green-900">Price/Month</p>
                                            <p className="text-lg font-semibold text-green-600">${plan.price_per_month}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-purple-50 p-4 rounded-lg">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-3">
                                            <p className="text-sm font-medium text-purple-900">Subscribers</p>
                                ...
                                <div className={`${plan.is_default ? 'bg-yellow-50' : 'bg-gray-50'} p-4 rounded-lg`}>
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-3">
                                            <p className={`text-sm font-medium ${plan.is_default ? 'text-yellow-900' : 'text-gray-900'}`}>Status</p>
                                            <p className={`text-lg font-semibold ${plan.is_default ? 'text-yellow-600' : 'text-gray-600'}`}>
                                                {plan.is_default ? 'Default' : 'Standard'}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-900">{new Date(plan.created_at).toLocaleDateString()} at {new Date(plan.created_at).toLocaleTimeString()}</p>
                                </div>
                                <div>
                                    <h4 className="text-sm font-medium text-gray-500">Last Updated</h4>
                                    <p className="mt-1 text-sm text-gray-900">{new Date(plan.updated_at).toLocaleDateString()} at {new Date(plan.updated_at).toLocaleTimeString()}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="p-6">
                            ...
                            {plan.subscriptions.length === 0 ? (
                                <div className="text-center py-8">
                                    ...
                                    <h4 className="mt-4 text-lg font-medium text-gray-900">No Subscribers Yet</h4>
                                    <p className="mt-2 text-gray-600">This plan doesn't have any subscribers.</p>
                                </div>
                            ) : (
