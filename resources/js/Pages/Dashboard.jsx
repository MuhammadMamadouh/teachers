                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                            ...
                                            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
                                                ...
                                                <p className="text-sm font-medium text-green-800">إجمالي الطلاب في المجموعات</p>
                                                <p className="text-2xl font-bold text-green-900">{reports.groups.total_students_in_groups}</p>
                                            </div>

                                            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-center">
                                                <Users className="mx-auto h-8 w-8 text-yellow-600 mb-2" />
                                                <p className="text-sm font-medium text-yellow-800">إجمالي الطلاب بدون مجموعة</p>
                                                <p className="text-2xl font-bold text-yellow-900">{reports.groups.total_students_without_group}</p>
                                            </div>
